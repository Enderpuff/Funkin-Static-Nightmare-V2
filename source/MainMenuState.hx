...
{
	public static var modVersion: String = "2.0.0";
	...
	public static var cameFromSecret:Bool = false;
	...
	override function create()
	{
		if(FlxG.sound.music == null) {
			FlxG.sound.playMusic(Paths.music('memories'), 0);

			FlxG.sound.music.fadeIn(4, 0, 0.7);
		}

		options.OptionsState.secretMenu = false;
		...
		if (cameFromSecret)
		{
			...
			menuItems.forEach(function(spr:FlxSprite)
			{
				FlxTween.tween(spr, {x: 370}, 0.5);
			});
			new FlxTimer().start(0.5, function(tmr:FlxTimer){
				cameFromSecret = false;
			});
		}

		FlxG.camera.follow(camFollowPos, null, 1);

		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "Static Nightmare v" + modVersion, 12);
	...
	override function update(elapsed:Float)
	{
		...
		{
			FlxTween.tween(bg, {x: 1280}, 0.1);
			menuItems.forEach(function(spr:FlxSprite)
			{
				FlxTween.tween(spr, {x: 2000}, 0.1);
			});
		...
		if (!selectedSomethin)
		{
			...
			if (controls.ACCEPT)
			{
				...
				{
					CoolUtil.browserLoad('https://discord.gg/WYHjkC6jPm');
				}
				else
				{
